            ...
            {*/
                ...
                if ($request->isMethod('POST')) {
                  ...
                  if ($form->isSubmitted() && $form->isValid()) {
                    ...
                    // On redirige vers la page de visualisation de la competence nouvellement créée
                    return $this->redirectToRoute('yk_competences_show', array('id' => $competence->getId()));
                   }
                }
